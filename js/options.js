...
function save_options(){
    ...
    localStorage['addDeleteButton'] = document.getElementById('add_delete_button').checked ? "true" : "false";
  ...
  function init(){
    ...
    if(localStorage['addDeleteButton'])
      document.getElementById('add_delete_button').checked = localStorage["addDeleteButton"] == "true" ? true : false;
  }
